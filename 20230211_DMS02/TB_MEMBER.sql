...
(
    PRODUCT_SERIAL_NUMBER varchar(63)     null comment '제품 시리얼 번호',
    CUSTOMER_LINK_NUMBER  int(20) auto_increment comment '고객 연동 번호'
        primary key,
    ...
    constraint TB_MEMBER_TB_KEPCO_API_AUTH_null_fk
